...
SWEP.Primary.Sound = Sound( "Shooter_AR15.Single" )
SWEP.Primary.Recoil = 5 / 1.8
SWEP.Primary.Damage = 55 / 1
SWEP.Primary.NumShots = 1
SWEP.Primary.Cone = 0.03
SWEP.Primary.Delay = 0.09 / 0.6
SWEP.Primary.BumpStockDelay = 0.09 / 0.7
...
SWEP.IronsightsPos = Vector(-6.12, 0, -1.321)
SWEP.IronsightsAng = Angle(0, 0, 0)
...
if CLIENT then
	killicon.AddFont( "shooter_ar15", "CSKillIcons", SWEP.IconLetter, Color( 255, 80, 0, 255 ) )
end