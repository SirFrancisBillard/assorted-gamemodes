...
game.AddAmmoType({name = "prisonshotgun"})
if CLIENT then
	language.Add("prisonshotgun_ammo", "Shotgun Shells")
end
...
SWEP.Primary.Ammo = "prisonshotgun"
...
SWEP.Primary.SoundNear = Sound("Weapon_Shotgun.Near")
